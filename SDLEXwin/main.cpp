...
int main(int argc, char* argv[])
{
    ...
    while(1) 
    {
		...
		sprintf(temp, "Prueba de Libreria de Graficos 2D, presiona A,S,Q y las flechas y mouse %d %d",Background.x,Background.y);
		fontsurf = TTF_RenderText_Solid(font,temp,color);

		SDL_Surface *NewSurface = MK_SurfaceRot(NewSurface2,Background.y,32,32,1,0x00FF00FF);
